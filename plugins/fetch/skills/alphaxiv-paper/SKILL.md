---
name: alphaxiv-paper
description: Use when user shares an arxiv or alphaxiv URL, mentions a paper ID like 2401.12345, or asks to explain, summarize, or analyze a research paper. Fetches structured AI-generated overview from alphaxiv.org instead of reading raw PDFs.
---
...
Accepts an optional `output_dir`. When omitted, write to a fresh temp directory.
Create the directory if it does not exist and never write outside it.

Print the result as the final line of stdout:
